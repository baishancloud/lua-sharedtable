...
int st_rbtree_init(st_rbtree_t *tree, st_rbtree_node_t *sentinel,
        st_rbtree_compare_pt cmp)
{
    st_must(tree != NULL, ST_ARG_INVALID);
    st_must(sentinel != NULL, ST_ARG_INVALID);
...
st_rbtree_node_t * st_rbtree_min(st_rbtree_t *tree)
{
...
st_rbtree_node_t * st_rbtree_max(st_rbtree_t *tree)
{
    st_rbtree_node_t *node = NULL;
    st_rbtree_node_t *sentinel = tree->sentinel;
...
static st_rbtree_node_t * get_min(st_rbtree_node_t *node, st_rbtree_node_t *sentinel) {
...
static st_rbtree_node_t * delete_node(st_rbtree_t *tree, st_rbtree_node_t *node)
{
    ...
    if (node->left == sentinel) {
        ...
        successor = get_min(node->right, sentinel);
